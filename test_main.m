...
delta_ang_display = zeros(len,3);
corrected_delta_vel_display = zeros(len,3);
index = 1;
for i = 1:len
...
%     baro.hgt = data.BAR0.Hight(baro_index,:);
    ...
    if correct_update
        ...
        delta_ang_display(index,:) = delta_ang;
        corrected_delta_vel_display(index,:) = corrected_delta_vel;
        index = index + 1;
...
subplot(311)
plot(t,quat_angle_out_display(:,1),t,quat_angle_out_display(:,2),t,quat_angle_out_display(:,3),t,quat_angle_out_display(:,4))
subplot(312)
plot(t,ang_out_display(:,1),'*',t,ang_out_display(:,2),t,ang_out_display(:,3));
subplot(313)
plot(t,vel_out_display(:,1),'*',t,vel_out_display(:,2),t,vel_out_display(:,3));
...
%%
figure('Name','delta_ang correct vel')
subplot(211)
plot(t,delta_ang_display(:,1),t,delta_ang_display(:,2),t,delta_ang_display(:,3))
subplot(212)
plot(t,corrected_delta_vel_display(:,1),t,corrected_delta_vel_display(:,2),t,corrected_delta_vel_display(:,3))
%%
figure('Name','quat_nominal')
subplot(211)
plot(t,states_quat_nominal(:,1))
subplot(212)
plot(t,states_quat_nominal(:,2),plot(t,states_quat_nominal(:,3)),plot(t,states_quat_nominal(:,4)));
%%
